document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById("toggleDark").addEventListener("click", (d) => {
    ...
    html.classList.contains("dark") ?
      (d.target.textContent = "Modo Claro☀️", inicio.classList.replace("light-img", "dark-img")) :
      (d.target.textContent = "Modo Oscuro🌙", inicio.classList.replace("dark-img", "light-img"))
  });
